                        ...
                        <div className="md:flex flex-row-reverse">
                            <div className="md:w-1/3 p-6 flex justify-center items-center">
                                <div className="relative w-full h-48 rounded-lg overflow-hidden border border-gray-700">
                                    <img src="/images/college.png" alt="College" className="w-full h-full object-cover" />
                                </div>
                            </div>
                            <div className="md:w-2/3 p-6">
                                <CardHeader className="p-0 mb-4">
                                    <CardTitle className="text-2xl text-white">Vellore Institute of Technology (VIT), Vellore</CardTitle>
                                ...
                                <CardContent className="p-0 space-y-4">
                                    <p className="text-gray-300">
                                        Established in 1984, VIT Vellore is a top-ranked private university accredited with NAAC A++ and recognized for excellence in engineering, technology, and research. The School of Computer Science and Engineering offers cutting-edge programs and fosters innovation and industry collaboration.
                                    </p>
                                    ...
                                    <Button variant="" className="gap-2">
                                        ...
                                        <a href="https://vit.ac.in/" target="_blank" rel="noopener noreferrer">Visit College Website</a>
                                    </Button>
                                </CardContent>
                            </div>
                        </div>
